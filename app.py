...
LESSON_PAGES = [
    ...
    {"slug": "growth-vs-dividend", "level": "intermediate", "file": "lesson-growth-vs-dividend.html", "title": "Growth vs Dividend Stocks"},
    {"slug": "valuation", "level": "intermediate", "file": "lesson-valuation.html", "title": "Valuation"},
    {"slug": "asset-allocation", "level": "intermediate", "file": "lesson-asset-allocation.html", "title": "Asset Allocation"},
    {"slug": "correlation", "level": "intermediate", "file": "lesson-correlation.html", "title": "Correlation"},
    ...
    {"slug": "what-is-an-option", "level": "pro", "file": "lesson-what-is-an-option.html", "title": "What Is an Option?"},
    {"slug": "the-greeks", "level": "pro", "file": "lesson-the-greeks.html", "title": "The Greeks"},
    ...
    {"slug": "cross-asset-correlation", "level": "pro", "file": "lesson-cross-asset-correlation.html", "title": "Cross-Asset Correlation"},
    {"slug": "commodities-safe-havens", "level": "pro", "file": "lesson-commodities-safe-havens.html", "title": "Commodities & Safe Havens"},
]
...
LESSON_FAQ = {
    ...
    "diversify": [
        {"question": "Can you give me a real example?", "answer": "Jordan put $10,000 into one stock; Priya put $10,000 into a diversified fund of 500+ companies. In a rough market year, Jordan's single stock fell 45% (down to $5,500), while Priya's fund fell only 8% (down to $9,200). Same starting amount, same bad year \u2014 but Priya's outcome depended on hundreds of businesses instead of one."},
        {"question": "Does diversifying mean I can't lose money?", "answer": "No. A diversified portfolio can still lose value when the whole market falls \u2014 the lesson's own numbers show a diversified holding dropping about 35% in a severe downturn. The point isn't eliminating risk, it's avoiding having your entire outcome depend on one company."},
        {"question": "What's the biggest risk of putting everything into one stock?", "answer": "If that single company has a bad year \u2014 or fails completely \u2014 your whole portfolio feels it. The lesson's table shows that if one holding making up 100% of your portfolio dropped to zero, you'd lose the full $10,000, versus keeping $6,500 if that same money had been diversified across many holdings in a severe downturn instead."},
    ],
    "invest-consistently": [
        {"question": "Can you give me a real example?", "answer": "Alex invested $500 every month for a year ($6,000 total) regardless of price, ending with $7,682. Jamie waited for the 'right moment,' then invested the full $6,000 in month 7 near that year's peak price, ending with $6,522. Alex came out over $1,000 ahead purely by not needing to guess the right time."},
        {"question": "Isn't it better to wait for the market to dip before investing?", "answer": "The lesson points out that nobody \u2014 not even professional fund managers \u2014 can reliably predict short-term price moves. Waiting for a 'right moment' often means watching prices move without you, then investing once it 'feels safe,' which is usually after prices have already risen, as happened to Jamie."},
        {"question": "What's the biggest mistake people make with timing?", "answer": "Trying to guess the single best month to invest a lump sum. The lesson's table shows outcomes for investing $6,000 in different months ranged from $6,000 to $9,615, with no way to know in advance which month would win \u2014 investing on a fixed schedule avoids needing to make that guess at all."},
    ],
    "keep-costs-low": [
        {"question": "Can you give me a real example?", "answer": "Nadia and Ryan each invested $300/month for 30 years in funds earning the same 8% average return before fees. Nadia's fund charged 0.05% annually and grew to $442,596; Ryan's charged 1.50% and grew to only $331,853 \u2014 a $110,743 gap from fees alone, even though they contributed the same $108,000."},
        {"question": "What's the biggest mistake people make with fees?", "answer": "Not checking a fund's annual expense ratio because it's deducted quietly from the fund's value rather than billed directly. The lesson shows every extra 0.25% in annual fees can cost tens of thousands of dollars over an investing lifetime, so checking this number is one of the highest-leverage things an investor can do."},
        {"question": "What are some ways to actually lower my costs?", "answer": "The lesson suggests tracking every deposit, trade, and fee so you notice how much you're really paying; using invite codes when signing up for a broker, since the referral perk is often free; comparing whether a platform has a cheaper 'pro' mode for simple buy-and-hold trades; and simply transacting less, since every trade can add a commission, spread, or conversion fee."},
    ],
    "think-in-decades": [
        {"question": "Can you give me a real example?", "answer": "Priya and Marcus each invested $10,000 in an S&P 500 index fund in January 2004 for 20 years. Priya stayed fully invested and ended with $43,030. Marcus got nervous, sold, and missed the single 10 best trading days of the two decades, ending with only $19,734 \u2014 less than half of Priya's result \u2014 despite being invested almost the whole time."},
        {"question": "Why can't I just sell before a crash and buy back in later?", "answer": "The lesson shows that in the 2004\u20132023 window, every one of the 10 best trading days happened during the 2008 financial crisis or the 2020 COVID crash \u2014 the exact weeks a nervous investor would already have sold or would still be too scared to buy back in. Missing just those days cost Marcus $23,296 compared to staying invested."},
        {"question": "What's the biggest mistake people make here?", "answer": "Checking their portfolio constantly and reacting emotionally to single bad days, or moving to cash after a drop and waiting for it to 'feel safe' before buying back in. The lesson notes this pattern of trying to dodge bad days usually means missing the best recovery days too, since they tend to happen close together during scary periods."},
    ],
    "stocks": [
        {"question": "Can you give me a real example?", "answer": "Owning 100 shares of Apple (out of about 14.69 billion outstanding) represents roughly 0.0000007% of the company, but it's still a real ownership stake \u2014 with about $840/year of profit attributable to those shares, of which $108/year is actually paid out as a dividend. The rest stays in the company to fund growth."},
        {"question": "Do dividends really make that much of a difference?", "answer": "In the lesson's example, Coca-Cola's share price alone rose 134.1% from 2004 to 2023, turning $10,000 into $23,408. But reinvesting the dividends along the way brought the total return to 325.2%, or $42,523 \u2014 meaning 58.8% of the total gain came from dividends, not just the rising share price."},
        {"question": "What's the biggest risk of owning an individual stock?", "answer": "A single company can go to zero \u2014 its stock isn't guaranteed to pay dividends or hold its value, and your ownership is only as strong as that one business. The lesson notes this is exactly the kind of company-specific risk that a diversified fund, covered in the next lesson, is designed to spread out."},
    ],
    "etfs": [
        {"question": "Can you give me a real example?", "answer": "One share of VOO (about $690) gives you a slice of roughly 500 U.S. companies in a single trade. Buying just 1 share each of VOO's top 10 holdings individually would cost $4,183 across 10 separate trades, and you'd still own only 10 of the fund's ~500 companies."},
        {"question": "What happens if one company in the ETF does badly?", "answer": "Because ETFs spread ownership across many companies, one company's decline has limited impact. The lesson notes that Nvidia, VOO's single largest holding, is still only 7.5% of the fund \u2014 so if Nvidia's stock fell to $0 overnight, VOO would fall by roughly 7.5%, not 100%."},
        {"question": "Are all ETFs equally diversified?", "answer": "No. The lesson warns that not all ETFs are broadly diversified \u2014 some track a single sector, country, or theme, and can carry risk much closer to owning individual stocks. It's worth checking what index an ETF actually follows and how many holdings it has before assuming it's broadly spread out."},
    ],
    "bonds": [
        {"question": "Can you give me a real example?", "answer": "David lends the U.S. government $10,000 by buying a 10-year Treasury bond with a 4.5% annual coupon. He's owed $450 per year in interest, totaling $4,500 over 10 years, plus his original $10,000 back at maturity \u2014 $14,500 total, known in advance."},
        {"question": "Are bonds risk-free since I know what I'm owed?", "answer": "No. The lesson shows that in 2022, a broad bond fund (AGG) still lost 12.4% of its value as interest rates rose rapidly \u2014 one of bonds' worst years on record. Bonds are generally less volatile than stocks and can cushion a portfolio, as they did in 2008, but they aren't guaranteed to hold their value."},
        {"question": "What's the difference between owning a bond and owning a stock?", "answer": "Buying a bond makes you a lender, not an owner \u2014 you get fixed interest payments and your money back at a set date, and bondholders get paid before stockholders even in a bankruptcy. A stock instead makes you a part-owner with no guaranteed payment, and its value depends on the company's future profits."},
    ],
    "cash": [
        {"question": "Can you give me a real example?", "answer": "In 2022, the average U.S. savings account paid about 0.06% while inflation peaked at 9.1% \u2014 meaning cash sitting in a typical account lost roughly 9 percentage points of real purchasing power that year, even though the account balance never went down."},
        {"question": "If my balance never drops, how can cash lose value?", "answer": "The lesson's example shows $10,000 in a 0% checking account over 10 years still shows $10,000 on the statement, but with 3% average inflation it can only actually buy what $7,441 buys today \u2014 a real loss of $2,559, even though the number never fell."},
        {"question": "What's the biggest mistake people make with cash?", "answer": "Assuming 'safe' means 'loss-free.' The lesson stresses that cash's real enemy isn't a market crash, it's inflation quietly eating away at purchasing power every year \u2014 so it's worth checking whether your actual interest rate is keeping pace with inflation, rather than assuming a stable balance means no loss."},
    ],
    "alternatives": [
        {"question": "Can you give me a real example?", "answer": "In 2008, during the global financial crisis, the S&P 500 fell 36.2% while gold (GLD) actually rose 2.0%. The lesson uses this as a real historical example of how an alternative asset can move differently from stocks during a crisis, though it notes this pattern isn't guaranteed to repeat."},
        {"question": "Are alternative assets safer than stocks?", "answer": "Not necessarily \u2014 the lesson is explicit that 'alternative' doesn't mean 'safer.' Bitcoin, for example, showed 55.5% annualized volatility from 2019\u20132024 versus the S&P 500's 21.0%, and a much steeper historical drawdown, meaning some alternatives carry considerably more risk in exchange for their diversification potential."},
        {"question": "How much of a portfolio should go into alternatives?", "answer": "The lesson mentions 5-10% as a figure often cited as a starting point, framed as 'seasoning' rather than the main part of a portfolio, given how much more volatile some alternatives can be. It stresses this is a commonly cited approach, not a fixed rule, and sizing should reflect the asset's higher swings."},
    ],
    "candlesticks": [
        {"question": "Can you give me a real example?", "answer": "On March 13, 2020, AAPL opened at $264.89 and closed at $277.97 \u2014 a large green (bullish) candle. Three days later, on March 16, it opened at $255.94 and closed at $242.21 \u2014 a large red (bearish) candle. Same stock, similar size of move, opposite direction, during the early COVID-19 sell-off."},
        {"question": "What's the biggest mistake people make reading candles?", "answer": "Treating a single dramatic candle as a forecast rather than a record of what already happened. The lesson stresses that one candle rarely tells the full story \u2014 it's most useful alongside the candles around it, which is what trend lines and moving averages help reveal."},
        {"question": "What does a doji candle tell you?", "answer": "A doji is a candle with a tiny body and long wicks, meaning the price swung around a lot during the period but ended up roughly where it started. It's often read as a sign of indecision between buyers and sellers, rather than a clear directional move."},
    ],
    "trend-lines": [
        {"question": "Can you give me a real example?", "answer": "The lesson traces the S&P 500 from its Jan 3, 2022 high of $4,796.56 down to a lower high on Mar 29 ($4,631.60) and a lower low on Jun 16 ($3,666.77) \u2014 a clear downtrend. After bottoming Oct 12, 2022, it reversed into an uptrend with higher highs by Feb 2023 and July 2023, using the same index throughout."},
        {"question": "What's the biggest mistake people make with trend lines?", "answer": "Connecting the wrong swing points \u2014 for example drawing a line under the highs of a downtrend instead of the highs above it. The lesson notes this is the single most common beginner mistake: uptrend lines connect the lows underneath price, downtrend lines connect the highs above it."},
        {"question": "Does breaking a trend line mean the trend has reversed?", "answer": "Not necessarily. The lesson describes a 'breakout' through a trend line as a signal, not a certainty \u2014 prices often punch through and snap back in a 'false breakout,' so one break alone shouldn't be treated as proof the trend has changed."},
    ],
    "volume": [
        {"question": "Can you give me a real example?", "answer": "On Jan 7, 2020, AAPL barely moved (-0.48%) on almost exactly average volume \u2014 an unremarkable day. On Mar 12, 2020, during the COVID sell-off, AAPL fell 3.02% on 418.5 million shares, over 4x its recent average \u2014 a real, high-conviction move with far more investors actively agreeing the price needed to reset."},
        {"question": "What's the biggest mistake people make reading volume?", "answer": "Comparing volume to a fixed number instead of that stock's own recent average. The lesson notes 50 million shares is huge for a small-cap stock but nothing for a mega-cap like Apple, so what matters is the multiple versus that stock's normal volume, not the raw figure."},
        {"question": "What's a warning sign to watch for in volume?", "answer": "A rising price on shrinking volume is a classic warning sign \u2014 it suggests fewer and fewer buyers are willing to keep pushing the price higher, even as it keeps drifting up. The lesson notes volume confirms a move rather than predicting one, so this pattern is worth noting, not acting on alone."},
    ],
    "support-resistance": [
        {"question": "Can you give me a real example?", "answer": "The S&P 500's Jan 2022 all-time high of $4,796.56 acted as resistance, rejecting the index twice in Dec 2023 and Jan 2024. On Jan 19, 2024 it finally closed decisively above that level, and from then on it never closed back below it through mid-February \u2014 the old ceiling had become the new floor."},
        {"question": "What's the most useful pattern to recognize here?", "answer": "Role reversal \u2014 once a resistance level is decisively broken, it often flips and becomes new support on the way back down, and vice versa for broken support. The lesson calls this the single most useful idea in the topic, though it's a probability, not a guarantee."},
        {"question": "What's the biggest mistake people make with these levels?", "answer": "Treating a support or resistance level as an exact price rather than a general zone, or assuming a level will always hold. The lesson stresses these are zones based on price memory, and a level can fail \u2014 every test should be treated as a probability, not a certainty."},
    ],
    "moving-averages": [
        {"question": "Can you give me a real example?", "answer": "On Mar 14, 2022, the S&P 500's 50-day average slipped below its 200-day average \u2014 a 'death cross' \u2014 as the 2022 bear market got underway. On Feb 2, 2023, the pattern flipped into a 'golden cross' as the index began its recovery, though both crosses happened well after the actual price turns."},
        {"question": "What's the biggest limitation of moving averages?", "answer": "They're a lagging indicator \u2014 because a moving average is built from past prices, it always reacts to a trend change after the fact, never before. The lesson notes crosses are confirmation tools, not early warnings, since a meaningful chunk of the price move has usually already happened by the time one occurs."},
        {"question": "What's the difference between a simple and exponential moving average?", "answer": "A simple moving average (SMA) weights every day in its window equally, while an exponential moving average (EMA) weights recent days more heavily so it reacts faster to new information. Both smooth out price noise to reveal the underlying trend \u2014 they just trade off lag versus responsiveness differently."},
    ],
    "chart-patterns": [
        {"question": "Can you give me a real example?", "answer": "The lesson walks through an illustrative head & shoulders top: a left shoulder at $118, a higher head at $130, a neckline at $100, and a right shoulder failing to reach the head's high at $117. Once price closed below the $99 neckline, the pattern confirmed, with a rough downside target of $70 based on the head-to-neckline distance projected below."},
        {"question": "What's the biggest mistake people make with chart patterns?", "answer": "Assuming a pattern is complete before the key line actually breaks. The lesson stresses a head & shoulders or double top isn't confirmed until price closes through the neckline, and plenty of near-misses never confirm \u2014 treating an unfinished shape as a done deal is a common error."},
        {"question": "Do triangles always continue the existing trend?", "answer": "No. The lesson explicitly warns that despite looking like continuation patterns, a triangle can resolve against the prior trend, so it's important to wait for the actual breakout direction rather than assuming which way it will go."},
    ],
    "rsi": [
        {"question": "Can you give me a real example?", "answer": "The lesson's own calculator example uses an average gain of 2.4 and average loss of 0.5, giving RS = 4.8 and RSI \u2248 82.8 \u2014 solidly in overbought territory. That illustrates how RSI turns the balance of recent gains versus losses into a single 0-100 reading."},
        {"question": "What's the biggest mistake people make with RSI?", "answer": "Treating the 70/30 levels as hard rules rather than guidelines. The lesson notes a powerful trend can keep RSI pinned above 70 (or below 30) for a long stretch while price keeps moving the same direction, so an overbought reading doesn't mean an immediate reversal."},
        {"question": "What is 'bearish divergence' and why does it matter?", "answer": "Bearish divergence is when price makes a new high but RSI makes a lower high, hinting that momentum is fading even as price keeps climbing. The lesson says this divergence is often more useful to watch than the raw overbought/oversold level itself."},
    ],
    "macd": [
        {"question": "Can you give me a real example?", "answer": "The lesson's calculator gives examples like a bullish crossover, where the MACD line moves from below the signal line to above it between two periods, versus a bearish crossover, the reverse move. These crossovers are read as momentum picking up or fading, respectively."},
        {"question": "What's the biggest mistake people make with MACD?", "answer": "Treating a crossover as a leading signal rather than a lagging one. The lesson stresses MACD is built from moving averages, so it confirms a shift after it's already begun \u2014 it never predicts one before it starts, and it can whipsaw with false crossovers in choppy, sideways markets."},
        {"question": "Why does the histogram matter if the crossover is the headline signal?", "answer": "A shrinking histogram means the MACD and signal lines are converging, which can hint that a crossover is approaching before it actually happens. The lesson notes this makes the histogram often more useful to watch than simply waiting for the crossover itself."},
    ],
    "bollinger-bands": [
        {"question": "Can you give me a real example?", "answer": "The lesson's calculator shows a 20-period moving average of $100 with a standard deviation of $1.5 producing an upper band of $103.00 (SMA + 2\u00d7stdev). This illustrates how the bands are built directly from recent price volatility rather than a fixed distance from price."},
        {"question": "What's the biggest mistake people make with Bollinger Bands?", "answer": "Assuming that price touching a band automatically means 'overbought' or 'oversold,' the way RSI readings are read. The lesson stresses that in a strong trend, price can 'walk the band' \u2014 riding along the upper or lower band for an extended stretch without reversing."},
        {"question": "What does a 'squeeze' tell you?", "answer": "A squeeze is when the bands pull tightly together, suggesting volatility has compressed and often preceding a sharp move. It doesn't tell you which direction that move will go, though \u2014 just that a bigger move may be building."},
    ],
    "confluence": [
        {"question": "Can you give me a real example?", "answer": "The lesson describes a scenario where RSI turns up from oversold, MACD makes a bullish crossover, and price bounces off a known support level \u2014 three unrelated tools agreeing at the same moment. That combination is stronger evidence than any one of them alone."},
        {"question": "What's the biggest mistake people make when combining indicators?", "answer": "Stacking several similar tools \u2014 like three momentum indicators \u2014 and mistaking their agreement for strong confirmation, when they tend to move together anyway. The lesson stresses independence matters more than quantity: mixing a momentum tool, a volatility tool, and a price-level tool is stronger evidence than piling on similar ones."},
        {"question": "Does confluence guarantee a trade will work out?", "answer": "No. The lesson is explicit that confluence reduces false signals and lowers the odds of reacting to noise, but even three aligned signals can still be wrong \u2014 it shifts the odds, it doesn't guarantee an outcome."},
    ],
    "income-statement": [
        {"question": "Can you give me a real example?", "answer": "The lesson's illustrative example shows net income jumping 77.3% year over year, which looks impressive \u2014 but $18M of that gain came from a one-off asset sale that wouldn't repeat. Stripping that out, underlying net income growth was closer to 33%, still healthy but far less dramatic than the headline number."},
        {"question": "What's the biggest mistake people make reading an income statement?", "answer": "Stopping at the headline net income number without checking where the profit actually came from. The lesson stresses that one-off items like asset sales, legal settlements, or tax credits can inflate net income for a single period without reflecting the ongoing business."},
        {"question": "Why do margins matter more than the raw profit number?", "answer": "Turning profit figures into margins by dividing by revenue lets you compare companies of very different sizes on equal footing. The lesson notes a $2 billion company with a 20% net margin is more profitable relative to its size than a $20 billion company with a 5% net margin."},
    ],
    "balance-sheet": [
        {"question": "Can you give me a real example?", "answer": "The lesson's illustrated example shows $250M in total assets funded by $125M of combined debt and $125M of shareholder equity, giving a debt-to-equity ratio of 1.0 \u2014 debt and equity funding the business equally, a reasonably balanced position for that company."},
        {"question": "What's the biggest mistake people make reading a balance sheet?", "answer": "Judging debt-to-equity against a single universal 'good' number rather than the company's industry. The lesson notes capital-intensive businesses like utilities or airlines naturally carry more debt than asset-light ones like software companies, so the ratio only means something in context."},
        {"question": "Is rising debt always a bad sign?", "answer": "No. The lesson explains that debt taken on to fund genuine growth is different from debt taken on to cover ongoing losses \u2014 the reason behind rising debt matters more than the fact that it's rising, which is why it's worth checking against the cash flow statement."},
    ],
    "cash-flow": [
        {"question": "Can you give me a real example?", "answer": "In the lesson's illustrative example, Year 2 net income grew 30%, but operating cash flow actually fell, because receivables \u2014 money customers owed but hadn't paid yet \u2014 jumped from $4.0M to $38.0M. The company was booking more sales on paper but collecting proportionally less real cash."},
        {"question": "What's the biggest mistake people make when judging profitability?", "answer": "Trusting net income alone without checking whether cash is actually following it. The lesson stresses that when operating cash flow lags well behind net income for multiple periods, it's often because profit is being recognized before the cash is actually collected \u2014 a quality-of-earnings red flag worth investigating."},
        {"question": "Why does free cash flow matter so much?", "answer": "Free cash flow (operating cash flow minus capital expenditures) is the real money left over to pay dividends, buy back stock, pay down debt, or reinvest. The lesson notes it's harder to manipulate with accounting choices than reported net income, making it often more trustworthy."},
    ],
    "growth-vs-dividend": [
        {"question": "Can you give me a real example?", "answer": "In the lesson's illustrative comparison, Growth Co delivered a 22% total return purely through price appreciation with no dividend, while Dividend Co returned 6% in price gains plus a 4% dividend yield for a 10% total return. Growth Co won that particular year, but Dividend Co's return came with more stability and a cash payment along the way."},
        {"question": "What's the biggest mistake people make comparing these two styles?", "answer": "Comparing only price charts, which understates a dividend stock's actual performance since it ignores the income paid along the way. The lesson stresses total return \u2014 price appreciation plus dividends \u2014 is the fair way to compare growth and dividend stocks."},
        {"question": "How do I know if a dividend is sustainable?", "answer": "Check the payout ratio \u2014 dividend per share divided by earnings per share. The lesson explains a low payout ratio leaves room for the dividend to grow, while a ratio near or above 100% is a flag that the company is paying out most or all of its earnings, leaving little cushion if profit dips."},
    ],
    "valuation": [
        {"question": "Can you give me a real example?", "answer": "The lesson compares two companies both trading at a P/E of 25 with the same $75 share price and $3 EPS. Company A is expected to grow earnings 30% a year, giving it a PEG of 0.83, while Company B is expected to grow only 10%, giving it a PEG of 2.50 \u2014 the same headline multiple, but a very different valuation story once growth is factored in."},
        {"question": "What's the biggest mistake people make with valuation ratios?", "answer": "Judging a stock by price alone, or trusting a single ratio without comparison. The lesson stresses a ratio like P/E only means something when compared against a company's own historical range and against direct industry peers \u2014 a ratio with no comparison point is just a number."},
        {"question": "Does a low valuation always mean a stock is cheap?", "answer": "Not necessarily. The lesson warns that a 'cheap' valuation can be cheap for a reason \u2014 declining businesses often trade at low multiples precisely because the market expects trouble ahead, so a low P/E or PEG should be checked against the company's actual fundamentals, not treated as an automatic bargain."},
    ],
    "asset-allocation": [
        {"question": "Can you give me a real example?", "answer": "The lesson compares three illustrative model portfolios: a conservative 30% stocks/70% bonds mix with lower average return and smaller swings, a balanced 60/40 mix in between, and an aggressive 90/10 mix with higher average return but larger swings. Same universe of assets, three very different outcomes, purely from changing the split."},
        {"question": "What's the biggest mistake people make with asset allocation?", "answer": "Focusing on picking the 'right' individual stock instead of the stocks/bonds/cash split itself. The lesson stresses that research consistently finds this split explains the vast majority of a portfolio's long-term risk and return, far more than security selection."},
        {"question": "Is there one 'correct' allocation everyone should use?", "answer": "No \u2014 the lesson is explicit that there's no universally correct allocation. The right mix depends on your own time horizon and risk tolerance, and it isn't a one-time decision either, since it should be revisited as your goals and circumstances change over time."},
    ],
    "correlation": [
        {"question": "Can you give me a real example?", "answer": "The lesson compares 20 tech stocks (averaging about 0.80 correlation) against a mixed portfolio of stocks, bonds, and gold (averaging about 0.25 correlation). Despite holding the same number of positions with similar individual volatility, the tech portfolio barely reduced overall volatility, while the mixed portfolio cut volatility by nearly half."},
        {"question": "What's the biggest mistake people make about diversification?", "answer": "Thinking that owning many holdings automatically means being diversified. The lesson stresses that 20 highly-correlated stocks \u2014 like 20 tech companies sharing the same economic drivers \u2014 concentrate risk almost as much as owning just two or three, since real diversification comes from how independently assets move, not how many you hold."},
        {"question": "Can correlations between assets change over time?", "answer": "Yes. The lesson notes correlations aren't fixed and can shift, and famously tend to rise during market crises \u2014 right when diversification is needed most. Historical correlation figures should be treated as a useful guide, not a guaranteed, fixed relationship."},
    ],
    "rebalancing": [
        {"question": "Can you give me a real example?", "answer": "The lesson walks through a $100,000 60/40 stocks/bonds portfolio where a strong stock rally shifted the mix to 67% stocks and 33% bonds, without the investor doing anything. Rebalancing meant selling $8,400 of stocks and buying $8,400 of bonds to bring it back to the original 60/40 target."},
        {"question": "What's the biggest mistake people make with rebalancing?", "answer": "Rebalancing on gut feeling instead of a fixed rule \u2014 which the lesson notes tends to mean never doing it, since selling what's been winning always feels uncomfortable. It stresses that having a calendar-based or threshold-based rule and actually following it matters more than which specific rule you pick."},
        {"question": "Why does an allocation drift even if I never trade?", "answer": "Because different assets grow at different rates. The lesson explains that if stocks rally while bonds stay flat, stocks naturally grow to take up more of the portfolio than originally intended \u2014 not because of any action taken, simply because they grew faster."},
    ],
    "position-sizing": [
        {"question": "Can you give me a real example?", "answer": "The lesson shows a $50,000 portfolio holding a stock that drops 30%: at a 5% position size, the loss is -1.5% of the total portfolio, but at a 50% position size, the same -30% move costs -15% of the portfolio. Same stock, same drop \u2014 the portfolio-level damage depends entirely on how large the position was allowed to get."},
        {"question": "What's the biggest mistake people make with position sizing?", "answer": "Treating high conviction in an idea as a substitute for a sizing plan. The lesson stresses that 'I'm really confident in this one' is exactly the thought that precedes most oversized, portfolio-damaging positions, and sizing rules should be set before you buy, not adjusted after you're already up big."},
        {"question": "What are the two common approaches to sizing a position?", "answer": "A simple maximum-weight rule, like capping any single stock at a set percentage of the portfolio, and a risk-based rule common in active trading, like risking only 1-2% of the account on a trade's stop-loss distance. Long-term investors tend to lean on the first and active traders on the second, but both aim to limit how much one position can hurt you if you're wrong."},
    ],
    "time-horizon": [
        {"question": "Can you give me a real example?", "answer": "The lesson illustrates three investors saving for retirement: a 25-year-old with 40 years to go holding a heavily stock-weighted mix, a 45-year-old with 20 years to go holding a more balanced mix, and a 63-year-old two years from retirement holding mostly bonds and cash. As the time horizon shortens, the mix shifts steadily away from stocks toward more stable assets."},
        {"question": "What's the biggest mistake people make matching risk to themselves?", "answer": "Assuming a long time horizon alone justifies taking maximum risk, without being honest about risk tolerance. The lesson stresses that even a 25-year-old with decades to go can have low risk tolerance, and taking on more volatility than you can actually stomach usually ends in panic-selling at the worst possible time."},
        {"question": "What's the difference between time horizon and risk tolerance?", "answer": "Time horizon is simply how long until you need the money, while risk tolerance is how much volatility you can handle emotionally and financially without abandoning the plan. The lesson explains both should shape your allocation, with risk tolerance acting as the ceiling on how much risk your time horizon otherwise supports."},
    ],
    "mean-reversion": [
        {"question": "Can you give me a real example?", "answer": "The lesson gives an illustrative stock with a 60-day historical mean of $100 and standard deviation of $5. A price of $115 gives a z-score of +3.0 (statistically stretched, a 'strong sell/fade' signal under a simple rule), while $82 gives a z-score of -3.6 (a 'strong buy/fade' signal) \u2014 both far from the near-mean $101 price, which shows no signal."},
        {"question": "What's the biggest risk of a mean-reversion strategy?", "answer": "The lesson calls 'catching a falling knife' the classic failure mode \u2014 a stock that's cheap for a genuine, lasting reason, like bad news or a broken business, can keep getting cheaper well past a -2 z-score. Not every asset actually mean-reverts, since a genuinely trending asset can keep making the z-score more extreme instead of reverting."},
        {"question": "How is this related to Bollinger Bands?", "answer": "The lesson notes it's essentially the same math \u2014 a Bollinger Band touch is a z-score extreme expressed visually rather than numerically. Both measure how far a price has stretched from its recent average in statistical terms."},
    ],
    "momentum-factors": [
        {"question": "Can you give me a real example?", "answer": "The lesson ranks five illustrative stocks by trailing 6-month return: Stock A (+42%) and Stock B (+31%) rank at the top and would be held under a simple momentum rule, while Stock C, D, and E rank lower and get no position. The strategy holds A and B purely because of their ranked return, not any view on their specific businesses."},
        {"question": "What's the biggest risk of a momentum strategy?", "answer": "Momentum crashes \u2014 the lesson notes momentum strategies have historically suffered sharp, sudden reversals, particularly around market turning points, even though the pattern of recent winners continuing to outperform is one of the most persistent patterns studied in academic finance."},
        {"question": "How is momentum different from mean reversion?", "answer": "Momentum bets that a trend already in motion tends to keep going, while mean reversion (the previous lesson) bets a stretched price snaps back \u2014 the mirror-image idea. The lesson notes they aren't contradictions, since they tend to operate over different timeframes and different assets can favor one over the other."},
    ],
    "backtesting": [
        {"question": "Can you give me a real example?", "answer": "The lesson shows a hypothetical strategy trading 240 times a year with an 18% gross annual return. Once realistic trading costs and slippage are factored in, that same strategy's net return drops to 6.5% \u2014 a large gap purely from frictions that are easy to ignore on paper."},
        {"question": "What's the biggest mistake people make when backtesting?", "answer": "Overfitting \u2014 tuning a strategy's rules so precisely to historical data that it has essentially memorized the past rather than found a real, repeatable pattern. The lesson notes the more parameters adjusted to fit historical data, the more likely the result is fitting noise, not signal."},
        {"question": "Does a good backtest guarantee a strategy will work?", "answer": "No. The lesson is explicit that a backtest is a simulation, not a guarantee \u2014 market conditions, liquidity, and competition all change over time, and a great backtest result is necessary but not sufficient to prove future performance."},
    ],
    "regime-detection": [
        {"question": "Can you give me a real example?", "answer": "The lesson illustrates a hypothetical index moving through three stretches: a calmer Jan-Jun period with 11% volatility and 0.35 correlation (low-vol trending), a choppier Jul-Sep period, and an Oct-Nov crisis period with 34% volatility and 0.81 correlation \u2014 showing how both volatility and correlation spiked together during the crisis."},
        {"question": "What's the biggest mistake people make about diversification during a crisis?", "answer": "Assuming diversified holdings will keep behaving independently during a downturn. The lesson notes correlation often spikes in crises, meaning normally-independent assets can start moving together exactly when diversification is needed most."},
        {"question": "Why doesn't one strategy work in every market condition?", "answer": "Because markets move through distinct regimes \u2014 low-volatility trending, range-bound, and high-volatility crisis \u2014 and a strategy tuned for one can struggle in another. The lesson gives the example of a momentum strategy shining in a trending regime but getting whipsawed in a choppy one, while mean reversion can suffer in a strongly trending regime."},
    ],
    "risk-budgeting": [
        {"question": "Can you give me a real example?", "answer": "The lesson compares bonds (6% volatility), large-cap stocks (16% volatility), and a small-cap stock (32% volatility), each given an equal $100,000 in an equal-dollar approach. Under that approach, the small-cap stock contributes over 5x as much risk to the portfolio as the bonds, despite the identical dollar size \u2014 the risk-budgeted approach instead sizes each position so their risk contributions are roughly balanced."},
        {"question": "What's the biggest mistake people make sizing a multi-asset portfolio?", "answer": "Assuming an equal dollar amount in different assets means an equal amount of risk. The lesson stresses this is the single most important idea in risk budgeting \u2014 a flat dollar allocation silently over-weights risk toward the most volatile positions."},
        {"question": "Does risk-budgeting make a portfolio automatically safer?", "answer": "No. The lesson notes risk parity isn't automatically 'safer' \u2014 it changes how risk is distributed across positions, but total portfolio risk still depends on how much overall exposure or leverage is applied on top of that distribution."},
    ],
    "what-is-an-option": [
        {"question": "Can you give me a real example?", "answer": "The lesson walks through a hypothetical $100-strike call bought for a $4 premium. Below $100 the option is worthless and the buyer's loss is capped at $4, at $104 the buyer breaks even, and at $115 the buyer gains $11 \u2014 showing capped downside and open-ended upside as the defining shape of a long call."},
        {"question": "What's the biggest mistake people make about options risk?", "answer": "Confusing the buyer's risk with the seller's. The lesson explains a buyer's maximum loss is capped at the premium paid, while an option seller \u2014 especially one selling an uncovered call \u2014 can face theoretically unlimited risk if the market moves sharply against the position."},
        {"question": "What does it mean for an option to be 'in the money'?", "answer": "It means the option would be exercised profitably at that moment \u2014 a call is in the money when the stock price is above the strike, and a put is in the money when the stock price is below the strike. An option that's out of the money at expiration is worth exactly zero, and the premium paid is gone."},
    ],
    "the-greeks": [
        {"question": "Can you give me a real example?", "answer": "The lesson's illustrative position has a delta of +0.55 (gains about $0.55 per $1 the stock rises), a theta of -0.08 (loses about $0.08 of value per day just from time passing), and a vega of +0.12 (gains about $0.12 if implied volatility rises 1 point) \u2014 showing how several forces move the option's value at once, not just the stock price."},
        {"question": "What's the biggest mistake people make watching an options position?", "answer": "Only watching the stock price and ignoring the other forces at work. The lesson stresses a trader who only watches the stock price is ignoring at least three of the four Greeks \u2014 gamma, theta, and vega \u2014 actually moving their option's value day to day."},
        {"question": "Why does theta matter even if the stock doesn't move?", "answer": "Theta measures time decay \u2014 the value an option loses purely from one day passing, holding everything else constant. The lesson notes this decay is an ever-present drag on a long option position and tends to accelerate as expiration approaches."},
    ],
    "implied-volatility": [
        {"question": "Can you give me a real example?", "answer": "The lesson's illustrative index option shows a deep out-of-the-money put (15% below the current price) with 28% implied volatility, nearly double the equivalent out-of-the-money call at 14%. That gap reflects persistent market demand for downside crash protection, forming the classic downward-sloping skew seen in equity index options."},
        {"question": "What's the biggest mistake people make reading implied volatility?", "answer": "Looking at a single at-the-money IV number instead of the shape across strikes. The lesson stresses that reading the skew \u2014 how IV varies by strike \u2014 reveals what the options market is actually worried about, information a single IV figure doesn't carry."},
        {"question": "Does high implied volatility mean a stock is guaranteed to move a lot?", "answer": "No. The lesson is explicit that high IV means the market is pricing in a wider range of outcomes as more likely, not guaranteeing any particular move \u2014 it's a forward-looking market estimate, not a promise of what will actually happen."},
    ],
    "income-strategies": [
        {"question": "Can you give me a real example?", "answer": "The lesson's illustrative covered call sells a $110 call for a $3 premium against 100 shares owned at a $100 cost basis. If the stock rallies to $120, the seller's total gain is capped at $1,300 because the shares get called away at $110 \u2014 missing the extra $1,000 of upside a plain stockholder would have captured."},
        {"question": "What's the biggest mistake people make with these income strategies?", "answer": "Thinking the premium collected removes the underlying stock risk. The lesson stresses a covered call still loses right alongside the stock if it falls (just cushioned slightly by the premium), and a cash-secured put commits you to buying more shares even as the stock keeps falling \u2014 neither strategy is risk-free income."},
        {"question": "What's the difference between a covered call and a cash-secured put?", "answer": "A covered call means selling a call against stock you already own, capping your upside above the strike in exchange for premium income. A cash-secured put means selling a put while setting aside cash to buy shares at the strike if assigned \u2014 you keep the premium if the stock stays above the strike, or buy at a price you'd already decided you were happy with if it falls below."},
    ],
    "spreads-hedging": [
        {"question": "Can you give me a real example?", "answer": "The lesson compares a single $100 call bought for $6 against a bull call spread (buying that same $100 call and selling a $110 call for $2, net cost $4). The spread costs less upfront and has a smaller max loss, but caps the maximum gain at $6, no matter how high the stock eventually goes, versus the single call's uncapped upside."},
        {"question": "What's the biggest mistake people make with spreads?", "answer": "Not calculating the maximum gain and maximum loss before placing the trade. The lesson stresses a defined-risk position should have both numbers known upfront, and mismatched legs \u2014 different expirations or contract sizes \u2014 can quietly change the actual risk profile."},
        {"question": "Does hedging eliminate risk entirely?", "answer": "No. The lesson explains hedging costs something by design \u2014 a protective put's premium is the price of a guaranteed floor, similar to any insurance premium \u2014 and spreads and hedges reduce risk rather than eliminate market exposure entirely, since a position can still lose money within its defined range."},
    ],
    "central-bank-policy": [
        {"question": "Can you give me a real example?", "answer": "The lesson's illustrative 1-percentage-point rate hike typically raises new mortgage rates, lowers existing bond prices, reduces high-growth stock valuations (since future cash flows are discounted more heavily), and often strengthens the domestic currency as it attracts foreign capital \u2014 a single decision rippling across mortgages, bonds, stocks, and currencies at once."},
        {"question": "What's the biggest mistake people make watching rate decisions?", "answer": "Focusing only on the announced rate change and ignoring the accompanying guidance. The lesson stresses forward guidance about future rate paths is watched as closely as the decision itself, since a hint of more cuts or hikes to come can move markets more than the announced change."},
        {"question": "Why do rate hikes hit high-growth stocks harder than other stocks?", "answer": "Higher rates reduce the present value of a company's future cash flows, and more of a high-growth company's value sits in cash flows further out in the future. That means those distant cash flows get discounted more heavily when rates rise, hitting high-growth stock valuations hardest."},
    ],
    "yield-curve": [
        {"question": "Can you give me a real example?", "answer": "The lesson's illustrative inverted scenario shows a 2-year Treasury yielding 4.8% while the 10-year yields only 4.0% \u2014 the classic inversion signal, where short-term rates price in near-term tightness while long-term rates already reflect expectations of future rate cuts."},
        {"question": "What's the biggest mistake people make reading a yield curve inversion?", "answer": "Treating it as a precise short-term timing signal. The lesson stresses inversions have a long, variable historical lead time \u2014 many months to over a year \u2014 before a recession actually begins, and not every inversion has been followed by one."},
        {"question": "What does an inversion actually reflect?", "answer": "It typically reflects the bond market's belief that the central bank will be forced to cut rates in the future, usually because a slowdown or recession is expected \u2014 that expectation pulls future short-term rates below today's rate, flipping the normal upward-sloping curve."},
    ],
    "currency-markets": [
        {"question": "Can you give me a real example?", "answer": "The lesson's illustrative scenario shows Country A at 5.5% and Country B at 1.0% \u2014 a wide 4.5-point rate gap that has historically tended to strengthen Country A's currency, as capital flows toward the higher-yielding option, all else equal."},
        {"question": "What's the biggest mistake people make thinking about currency effects?", "answer": "Assuming currency moves are only a forex-trading concern with no relevance to stocks. The lesson stresses currency moves quietly reshape multinational companies' reported earnings, since foreign revenue translates into fewer or more home-currency dollars depending on how the home currency has moved."},
        {"question": "Are interest rates the only thing that moves currencies?", "answer": "No. The lesson lists trade balances, risk sentiment, and capital flows as also mattering \u2014 a country's trade surplus or deficit creates steady buying or selling pressure over time, and 'risk-on/risk-off' sentiment can move currencies like the US dollar, yen, or Swiss franc regardless of interest rate differentials at that moment."},
    ],
    "cross-asset-correlation": [
        {"question": "Can you give me a real example?", "answer": "The lesson's illustrative table shows stocks vs. government bonds moving from -0.30 correlation in a calm regime to +0.55 in a crisis regime \u2014 while a safe-haven currency's correlation to stocks actually strengthens negatively, from -0.20 to -0.65, in the same crisis."},
        {"question": "What's the biggest mistake people make trusting diversification?", "answer": "Assuming a portfolio that looks diversified based on calm-market correlation history will behave the same way in a crisis. The lesson stresses that a broad 'sell everything' dynamic can push correlations across many asset classes sharply toward +1 exactly when diversification is needed most."},
        {"question": "Do all assets correlate upward during a crisis?", "answer": "No. The lesson notes a small number of assets \u2014 like certain safe-haven currencies or gold \u2014 can maintain or even strengthen their negative correlation to stocks during stress, which is exactly what makes them valuable as crisis diversifiers."},
    ],
    "commodities-safe-havens": [
        {"question": "Can you give me a real example?", "answer": "The lesson's illustrative risk-off event shows stocks declining sharply while gold rises on store-of-value demand, oil often falls on growth-scare fears, and a safe-haven currency strengthens as capital flows toward perceived safety \u2014 showing how different commodities and currencies react in opposite directions during the same event."},
        {"question": "What's the biggest mistake people make treating commodities as one group?", "answer": "Assuming all commodities behave the same way in a crisis. The lesson stresses gold's store-of-value role differs sharply from oil's tie to real economic growth \u2014 gold often rises in a risk-off event while oil often falls alongside stocks instead of hedging them."},
        {"question": "Why does gold react to fear and confidence rather than just supply and demand?", "answer": "Gold has limited industrial use relative to its total supply, so it trades largely as a store of value that investors turn to when confidence in currencies, governments, or the financial system wavers. That's why gold often rises during high inflation, currency weakness, or geopolitical stress, even without a change in gold's own physical supply-and-demand picture."},
    ],
}
