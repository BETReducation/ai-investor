...
- [x] Workstream 1/2 spike: `realtime/` async service + Redis-bridged chart
      SSE, on branch `scaling-1000-users`. Not deployed; not wired to the
      frontend yet. See `realtime/README.md`.
...
- [ ] Everything else in the sequencing list above.

## Open questions (need Gary before this goes further)
